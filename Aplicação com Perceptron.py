# -*- coding: utf-8 -*-
"""
Created on Mon Sep 15 19:40:07 2025
...
neuronio = [0.22, -0.33, 0.44] #pesos das sinapses do neurônio
...
for _ in range(11):
    ...
    print (neuronio, "saida0 = ", saida0)
    neuronio, saida_0 = ajustes(neuronio, padrao_0_1, saida0)
    print (neuronio, "saida0 = ", saida0)
    neuronio, saida_0 = ajustes(neuronio, padrao_0_2, saida0)
    print (neuronio, "saida0 = ", saida0)
    neuronio, saida_0 = ajustes(neuronio, padrao_1_0, saida1)
    print (neuronio, "saida1 = ", saida1)
    neuronio, saida_0 = ajustes(neuronio, padrao_1_1, saida1)
    print (neuronio, "saida1 = ", saida1)
    neuronio, saida_0 = ajustes(neuronio, padrao_1_2, saida1)
    print (neuronio, "saida1 = ", saida1)
    n = n + 1;
...
# y = 1.0 - 1.125*x - equação da reta de separação de classes
x1 = [0.1, 0.1, 0.3]
x2 = [0.6, 0.8, 0.9]
y1 = [0.1, 0.5, 0.3]
y2 = [0.6, 0.2, 0.5]
